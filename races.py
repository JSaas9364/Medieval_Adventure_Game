...
races = {
    "Human": {
        ...
        "legendary_perk": {
            "Cartographer's Legacy": {
                "description": "Immune to ambushes, reveals hidden paths, loot, and threats on the map.",
                "bonuses": {
                    "XP_gain": "+10%",
                    "reputation_gain": "+10%",
    ...
    "Orc": {
        ...
        "racial_perks": {
            "Brutal Force": "+10% chance to stagger, -5% accuracy, +15% damage and accuracy vs bleeding enemies, -10% ranged/magic accuracy & casting speed",
